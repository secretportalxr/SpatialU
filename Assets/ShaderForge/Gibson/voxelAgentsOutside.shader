...
/*SF_DATA;ver:1.38;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,lico:0,lgpr:1,limd:3,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:True,hqlp:False,rprd:True,enco:False,rmgx:True,imps:True,rpth:1,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:0,bdst:1,dpts:2,wrdp:True,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:2865,x:33012,y:32713,varname:node_2865,prsc:2|diff-4662-OUT,diffpow-4662-OUT,spec-4662-OUT,gloss-4662-OUT,emission-7674-RGB,transm-4662-OUT,lwrap-4662-OUT,amdfl-4662-OUT,amspl-4662-OUT,difocc-4662-OUT,spcocc-4662-OUT;n:type:ShaderForge.SFN_Vector1,id:4662,x:32752,y:33026,varname:node_4662,prsc:2,v1:0;n:type:ShaderForge.SFN_Color,id:7674,x:32752,y:32760,ptovrint:False,ptlb:node_7674,ptin:_node_7674,varname:node_7674,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.5,c2:0.5,c3:0.5,c4:1;proporder:7674;pass:END;sub:END;*/

Shader "Shader Forge/voxelsAgentsOutside" {
    Properties {
        _node_7674 ("node_7674", Color) = (0.5,0.5,0.5,1)
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
...
////// Specular:
                ...
                float3 diffuseColor = float3(node_4662,node_4662,node_4662); // Need this for specular when using metallic
...
////// Emissive:
                float3 emissive = _node_7674.rgb;
/// Final Color:
                outDiffuse = half4( diffuseColor, node_4662 );
                outSpecSmoothness = half4( specularColor, gloss );
                outNormal = half4( normalDirection * 0.5 + 0.5, 1 );
                outEmission = half4( _node_7674.rgb, 1 );
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                o.Emission = _node_7674.rgb;
                
                float node_4662 = 0.0;
                float3 diffColor = float3(node_4662,node_4662,node_4662);
                float specularMonochrome;
                float3 specColor;
